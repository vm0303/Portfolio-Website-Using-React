                    ...
                    <div className="right">
                        <div className="social_media_Container">
                            <a className="icon" href="https://github.com/vm0303" target="_blank"
                               rel="noopener noreferrer" title="Github Page"><i className="fa-brands fa-github"></i></a>
                        </div>
                        <div className="social_media_Container">
                        ...
                        <div className="social_media_Container">
                            <a className="icon" href="https://www.linkedin.com/in/vishal-madhav/" target="_blank"
                               title="LinkedIn Page"><i className="fa-brands fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
            </div>
